...
********************************************/
	...
	set_time_limit (0);
	if(is_file("../../sphider/include/commonfuncs.php")) { // admin ajax actualiser suggestions
		$include_dir = "../../sphider/include";
		$settings_dir =  "../../sphider/settings";
		$admin_path = '../../sphider/admin';
	}
	else {
		$include_dir = "../include"; 
	...
	include "$admin_path/auth.php";
	require_once ("$include_dir/commonfuncs.php");
	$all = 0;
	extract (getHttpVars());
	require_once ("$settings_dir/conf.php");

	include "$admin_path/messages.php";
	include "$admin_path/spiderfuncs.php";
