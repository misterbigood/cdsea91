			...
			<div id="conteneur">
				...
				<section id="contenu" class="units-row cdsea">
					<article id="organigramme">
						...
						<div id="rateau" class="unit-centered width-50 rateau-2-divs"></div>
						<div class="units-row units-split">
						<div class="unit-50 join-top">
							<div class="org-2 no-icon //iconpeople iconpeople-3">
								<p><strong class="name">Cynthia DAUBE</strong><br>Coordinatrice</p>
							</div>
						</div>
						</div>
						<div class="unit-33 join-top">
							<div class="org-4 no-icon //iconpeople iconpeople-3">
