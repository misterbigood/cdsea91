...
<div id="conteneur">
  ...
  <div id="contenu">
    <h1>Documentation</h1>
	<div class="infoTop">
		<p>Le nom de chaque dossier est affiché sur la page Documentation.</p>
		<p>&nbsp;</p>
...
<script type="text/javascript" charset="utf-8">
	$().ready(function() {
		var elf = $('#elfinder').elfinder({
			url : 'js/elfinder/php/connector_documentation.php',  // connector URL (REQUIRED)
			lang : 'fr',
			commands : [
				'upload', 'open', 'reload', 'rm', 'download', 'info', 'rename', 'mkdir'
			]
		}).elfinder('instance');
