...
if($_SERVER['SERVER_NAME'] == 'localhost') {
	...
	$globalConfig['dbase']="cdsea"; // Your MySQL Database name
}
else {
	$globalConfig['dbhost']="mysql51-111.perso"; // Your MySQL Server Host URL
	$globalConfig['dbuser']="cdseabddsql"; // Your MySQL Username
	$globalConfig['dbpass']="uTxbklgUO"; // Your MySQL Password
	$globalConfig['dbase']="cdseabddsql"; // Your MySQL Database name
}
$globalConfig['tbl']="user"; // The name of the MySQL table to store the data required
...
**********************************************************************************
*/
$globalConfig['inactiveMin']="90"; // The time in minutes to force new login, if account has been inactive
$globalConfig['loginUrl']="login.html"; // The URL of the login page
$globalConfig['logoutUrl']="login.html"; // The URL of the logout page
/*
...
*/
$globalConfig['enblRemember']=true; // set true to enable Remember Me function
...
**********************************************************************************
*/
$globalConfig['errorCharset']="utf-8";
/*
**********************************************************************************
*/
$globalConfig['errorPageTitle']="NOT AUTHORIZED";
$globalConfig['errorPageH1']="page non autoris&eacute;e!";
$globalConfig['errorPageLink']="Cliquez pour vous authentifier";
$globalConfig['errorNoCookies']="Vous devez accepter les coockies pour pouvoir vous authentifier!";
$globalConfig['errorNoLogin']="Authentification requise!";
$globalConfig['errorInvalid']="Nom ou mot de passe invalide!";
$globalConfig['errorDelay']="Session inactive - merci de vous authentifier <br>";
$globalConfig['errorDelay'].="Ou vous avez utilis&eacute; le login plus d'une fois!<br>";
$globalConfig['errorDelay'].="Session inactive!";
$globalConfig['errorNoAdmin']="Vous devez avoir les droits d'administrateur pour consulter cette page!";
$globalConfig['errorNoGroup']="Vous n'appartenez pas au groupe d'utilisateurs autoris? ?consulter cette page!";
/*
