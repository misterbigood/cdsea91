...
AUDIO : NECESSITE D'INSTALLER FLITE

$oAudioCaptcha = new AudioPhpCaptcha('/usr/bin/flite', '/temp/');
...
*/
   ...
   define('CAPTCHA_MIN_FONT_SIZE', 14);
   ...
   define('CAPTCHA_AUDIO_PATH', '/temp/'); // must be writeable by PHP process
   ...
   class PhpCaptcha {
      ...
      function Validate($sUserCode, $bCaseInsensitive = true) {
         ...
         if (!empty($_SESSION[CAPTCHA_SESSION_ID]) && $sUserCode == strtoupper($_SESSION[CAPTCHA_SESSION_ID])) {
