...
if ( isset( $modified_args ) && $loop->have_posts() && ( (int) $loop->query['offset'] + 10 < (int) $loop->found_posts ) ) {
	...
	<div class="um-load-items">
		<a href="javascript:void(0);" class="um-ajax-paginate um-button" data-hook="um_bbpress_load_topics" data-args="<?php echo esc_attr( $modified_args ); ?>"><?php esc_html_e( 'load more topics', 'um-bbpress' ); ?></a>
	</div>
