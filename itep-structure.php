			...
			<div id="conteneur">
				...
				<section id="contenu" class="units-row itep">
					<article class="unit-66">
						...
						<p>L’ITEP et SESSAD de BRUNEHAUT organise aussi des week-ends découvertes. Cet accueil ludo-éducatif a pour objectif de faire découvrir des milieux différents aux enfants, 
