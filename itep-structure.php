				...
				<section id="contenu" class="units-row itep">
					<article class="unit-66">
						...
						<div class="doc-inser">
                                                ...
                                                <p>Situé dans un parc de 5 hectares, au cœur de la vallée classée de la Juine, l'Institut Thérapeutique, Educatif et Pédagogique du Château de BRUNEHAUT, à MORIGNY dans le sud du département de l'Essonne, bénéficie d'un agrément pour accueillir des garçons ou des filles âgés de 6 à 16 ans.</p>
						...
						<p>L’ITEP et SESSAD de BRUNEHAUT organise aussi des week-ends découverte. Cet accueil ludo-éducatif a pour objectif de faire découvrir des milieux différents aux enfants, 
                                                    augmenter leur culture générale, stimuler la socialisation des petits groupes ( 7 à 9 enfants) à travers des sujets plaisants dans un contexte de détente et d’amusement.</p>
